...
let eduCounter = parseInt(eduCounterV)
let compCounter = parseInt(compCounterV)
...
//     </td>
//                    <td><input type="checkbox" name="lang[${ele}][read]" value="true" disabled>Read</td>
//                    <td><input type="checkbox" name="lang[${ele}][write]" value="true" disabled>Write</td>
//                    <td><input type="checkbox" name="lang[${ele}][speak]" value="true" disabled>Speak</td>`
...
//     <small class="error">Atleast select one ability</small>
//     </td>
//                    <td><input type="radio" name="tech[${ele}][level]" value="beginner" disabled>Beginner</td>
//                    <td><input type="radio" name="tech[${ele}][level]" value="intermediate" disabled>Intermediate</td>
//                    <td><input type="radio" name="tech[${ele}][level]" value="expert" disabled>Expert</td>`
